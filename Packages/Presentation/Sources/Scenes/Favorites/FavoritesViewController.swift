...
final public class FavoritesViewController: BaseViewController {
    private var collectionView: UICollectionView!
    
    private let viewModel: FavoritesViewModel
    private let router: AppRouter
    
    public init(viewModel: FavoritesViewModel, router: AppRouter) {
    ...
    private func showEmpty() {
        ...
        empty.image = UIImage(systemName: "heart.fill")
